...
from mse_baseline_train import SpriteSeq2Seq, SpriteAnimDataset, FRAME_SIZE


def parse_args():
    parser = argparse.ArgumentParser()
    parser.add_argument('--checkpoint', type=str, default='./checkpoints_mse/best_model.pt')
    ...
    parser.add_argument('--output_dir', type=str, default='model_output_mse')
...
def main():
    ...
    save_grid(strips, './plot', 'MSE Baseline — Generated Animations', 'mse_inference_grid.png')
